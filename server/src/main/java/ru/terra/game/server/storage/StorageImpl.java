...
public class StorageImpl implements Storage {
    ...
    private final PlayersJpaController pjc = new PlayersJpaController();
    private final MapsJpaController mjc = new MapsJpaController();
    private final MapObjectJpaController mojc = new MapObjectJpaController();

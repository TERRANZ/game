...
import ru.terra.game.client.gui.lwjgl.Texture;
import ru.terra.game.client.gui.lwjgl.TextureLoader;
import ru.terra.game.client.gui.model.ObjLoader;
import ru.terra.game.client.gui.model.ObjModel;
...
public class Player extends AbstractEntity
{
	 ...
	 * @param shotTexture The texture to apply to the shot's created when the player fires
	 */
	...
	public void load()
	{
		...
		try
		{
			this.texture = loader.getTexture("/res/ship.jpg");
	...
	private void fire(EntityManager manager)
	{
		...
		Shot shot = new Shot(shotTexture, getX() + forwardX, getY() + forwardY, forwardX * 30, forwardY * 30);
	...
	public void hit(EntityManager manager, Shot shot)
	{
		health = health - shot.getDamage();
	}

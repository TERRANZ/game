...
public class GameManager {
    ...
    private final HashMap<Long, Player> enemies = new HashMap<Long, Player>();
    private final HashMap<Long, MapObject> mapObjects = new HashMap<Long, MapObject>();
    ...
    public void ok(OkPacket message) {
        ...
        if (getGameState() == GameState.LOGGING_IN) {
            playerLoggedIn(message.getGuid());

...
/**
 * A utility class to load textures for LWJGL. This source is based on a texture that can be found in the Java Gaming (www.javagaming.org) Wiki.
 * 
 * OpenGL uses a particular image format. Since the images that are loaded from disk may not match this format this loader introduces a intermediate
 * image which the source image is copied into. In turn, this image is used as source for the OpenGL texture.
 * 
 * @author Kevin Glass
 * @author Brian Matzon
 */

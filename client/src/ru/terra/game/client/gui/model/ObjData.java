package ru.terra.game.client.gui.model;
...
/**
 * The data that has been read from the Wavefront .obj file. This is kept seperate from the actual rendering with the hope the data might be used for
 * some other rendering engine in the future.
 * 
 * @author Kevin Glass
 */
public class ObjData
{
	...
	/**
	 * Read a set of 3 float values from a line assuming the first token on the line is the identifier
	 * 
	...
	/**
	 * Read a set of 2 float values from a line assuming the first token on the line is the identifier
	 * 
	 * @param line The line from which to read the 3 values

...
/**
 * This is a loader that will bring in the geometry from a Wavefront .obj file. This loader won't work for any OBJ and is only really intended to
 * demonstrate how things might work. For reference it doesn't:
 * <p>
...
public class ObjLoader
{
	 ...
	 * @throws IOException Indicates a failure to read the OBJ file from the specified file.
	 */

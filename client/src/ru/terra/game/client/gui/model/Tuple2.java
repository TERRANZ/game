...
/**
 * A simple tuple of 2 elements. A tuple is a set of values that relate to each other in some way. In this case its a set of 2 so it might represent a
 * vertex or normal in 2D space or a texture coordinate
 * 
 * @author Kevin Glass
 */
class Tuple2

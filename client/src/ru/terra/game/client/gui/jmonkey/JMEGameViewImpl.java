...
public class JMEGameViewImpl extends SimpleApplication implements ActionListener {
    ...
    private final float diffY = 50;
    private Geometry controlCube;

    private final HashMap<Player, Geometry> players = new HashMap<>();
    private final HashMap<MapObject, Geometry> mapObjects = new HashMap<>();
    private final HashMap<Long, Geometry> entities = new HashMap<>();
    private final HashMap<Long, CharacterControl> playerControls = new HashMap<>();
    private Material mat1;
    private boolean isMoving = false;
    private final CapsuleCollisionShape capsuleShape = new CapsuleCollisionShape(1.5f, 6f, 1);
